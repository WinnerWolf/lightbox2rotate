        ...
        Lightbox.prototype.changeImage = function(imageNumber) {
            ...
            preloader.onload = function() {
                ...
                if (_this.options.fitImagesInViewport) {
                    ...
                    if (_this.options.maxWidth && _this.options.maxWidth < maxImageWidth) {
                        maxImageWidth = _this.options.maxWidth;
                    }
                    if (_this.options.maxHeight && _this.options.maxHeight < maxImageWidth) {
                        maxImageHeight = _this.options.maxHeight;
                    }
